...
#define STRING_CONFIG_H_AUTHOR "Kyle Evans <self@kyle-evans.net>" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 "Welcome Back, Kyle" // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "PRINTER: Alpha"         // will be shown during bootup in line 2
 ...
 * Override with M92
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2000, 600 }
